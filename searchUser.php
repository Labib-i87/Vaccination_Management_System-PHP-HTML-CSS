    ...
    <form method="post" action="searchUser.php">
        <div class="inner-form">
            <div class="input-field first-wrap">
                ...
                <input type="text" name="unid" id="search" placeholder="Search User by NID" />
            </div>
...
if(count($_POST)>0) {
  if(!empty($_POST['unid'])) {
    $unid = $_POST['unid'];
    $result = mysqli_query($conn, "SELECT * FROM users WHERE nid = '$unid'");
  }
  else {
        ...
        <tbody>
            <tr style="vertical-align: middle;">
                ...
                <td class="text-center">
                    <a href='<?php echo "viewUser.php?uid=$row[0]"?>'><span class="btn btn-warning">View History</span></a>
                </td>
