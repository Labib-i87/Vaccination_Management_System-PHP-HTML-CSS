                ...
                <section class="mb-10">
                    ...
                    <div class="card mx-4 mx-md-5 text-center shadow-5-strong"
                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            <a class="btn   btn-warning btn-lg py-3 px-5 mb-2 me-2" href="login.php"
                                role="button" aria-controls="#picker-editor">Login</a>
                                <a class="btn   btn-warning btn-lg py-3 px-5 mb-2 me-2" href="signup.php"
                                role="button" aria-controls="#picker-editor">Sign Up</a>
                        </div>
                    </div>
                </section>
            </section>
