...
if(!empty($_SESSION['id']) && mysqli_num_rows($access) != 0){
  $id = $_SESSION['id'];
  $query = mysqli_query($conn, "SELECT admin_name FROM admin WHERE admin_id = '$id'");
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto">
            ...
            <button onclick="location.href='aDashboard.php'" type="button" class="btn btn-dark ms-3">Admin: <?php echo "$aname" ?></button>
          </ul>
        </div>
      </div>
    </nav>
                    ...
                    <div class="card mx-4 mx-md-5 text-center shadow-5-strong"
                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            <h1 class="display-3 fw-bold ls-tight mb-4">
                                <span>ADMIN</span> <br> <span class="text-warning">PANEL</span>
                            </h1>
                            <a class="btn   btn-warning btn-lg py-3 px-5 mb-2 me-2" href="aDashboard.php"
                                role="button" aria-controls="#picker-editor">Settings</a>
